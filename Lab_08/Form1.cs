...
namespace Lab_08
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)          // //add students
        {
        ...
        private void button2_Click(object sender, EventArgs e)      //show all records
        {
            dataGridView1.Rows.Clear();
        ...
        private void button3_Click(object sender, EventArgs e)         //sort by marks
        {
            dataGridView1.Rows.Clear();
        ...
        private void button4_Click(object sender, EventArgs e)      //sort by gender,marks and age
        {
            dataGridView1.Rows.Clear();
            var myString = from s in std
        ...
        private void button5_Click(object sender, EventArgs e)      //search by specific name
        {
            dataGridView1.Rows.Clear();
            if (textBox6.Text == "")
            {
        ...
        private void button6_Click(object sender, EventArgs e)         //search by marks
        {
            dataGridView1.Rows.Clear();
            if (textBox7.Text == "")
            {
                MessageBox.Show("Please enter mark to search");
            }
            else
            {
                var myString = from mark in std
